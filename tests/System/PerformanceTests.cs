...
public class PerformanceTests
{
    ...
    public void GetPerformanceTest()
    {
        ...
        Assert.IsTrue(
            ...
            $"L1L2Cache Get must perform significantly better (> 100) than RedisCache Get: {l2GetVsL1L2GetRatio}");
        ...
        Assert.IsTrue(
            ...
            $"L1L2Cache Get must perform better (> 3) than to RedisCache Get: {l1L2GetPropagationVsl2GetRatio}");
    }
    ...
    public void SetPerformanceTest()
    {
        ...
        Assert.IsTrue(
            ...
            $"L1L2Cache Set cannot perform significantly worse (< 3) than RedisCache Set: {l1L2SetVsl2SetRatio}");
    }
}
